...
export const AppToasts = {
  ...
  created: (itemName: string) => AppToasts.success(`${itemName} criado(a) com sucesso!`),
  updated: (itemName: string) => AppToasts.success(`${itemName} atualizado(a) com sucesso!`),
  deleted: (itemName: string) => AppToasts.success(`${itemName} excluído(a) com sucesso!`),
};