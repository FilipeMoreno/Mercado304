...
export async function searchProductByBarcode(barcode: string): Promise<any> {
	...
	// Buscar produto pelo código de barras na nova tabela
	...
	// Adicionar o barcode principal para compatibilidade
	return {
		...product,
		barcode: product.barcodes.find((b) => b.isPrimary)?.barcode || product.barcodes[0]?.barcode,
	}
}
