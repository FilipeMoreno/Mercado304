...
export class TempStorage {
	...
	static save(data: any, expiryHours: number = TempStorage.defaultExpiryHours): string {
	...
	static cleanup(): void {
		try {
			const keys = Object.keys(localStorage).filter((key) => key.startsWith(TempStorage.prefix))
