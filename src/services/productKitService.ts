...
/**
 * Atualiza os itens de um kit
 */
export async function updateProductKitItems(
  kitId: string,
 ...
 */
export async function getProductKitWithDetails(
  kitProductId: string
): Promise<ProductKitWithItems | null> {
 ...
 */
export async function calculateKitNutritionalInfo(
  kitProductId: string
): Promise<AggregatedNutritionalInfo | null> {
 ...
 */
export async function checkKitStockAvailability(
  kitProductId: string
): Promise<KitStockInfo> {
  const kit = await getProductKitWithDetails(kitProductId);
 ...
 */
export async function consumeKitFromStock(
  kitProductId: string,
  quantity: number,
  reason?: string
) {
 ...
 */
export async function addKitToStock(
  kitProductId: string,
  quantity: number,
  location?: string,
  unitCost?: number
