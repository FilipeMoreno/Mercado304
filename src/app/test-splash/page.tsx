      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Teste e visualize a splash screen do PWA
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Informações sobre o estado atual do Progressive Web App
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant={shouldShowSplash ? "default" : "secondary"}>
                {shouldShowSplash ? "Sim" : "Não"}
              </Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Botões para testar a funcionalidade da splash screen
            </CardDescription>
          </CardHeader>
