...
import { ShoppingCart, Eye, EyeOff, Mail, Lock, User, Loader2, Check } from 'lucide-react';
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "Junte-se a milhares de usuários que já transformaram sua forma de fazer compras. 
              Economize tempo, dinheiro e reduza o desperdício."
            </p>
            <footer className="text-sm">Comece sua jornada hoje</footer>
          </blockquote>
        </div>
      </div>
