...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const formattedSession = {
      ...
      lastMessage: Array.isArray(chatSession.messages) && chatSession.messages.length > 0
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const formattedSession = {
      ...
      lastMessage: Array.isArray(updatedSession.messages) && updatedSession.messages.length > 0
