...
export async function GET(
	...
	try {
		...
		if (!nutritionalInfo) {
			return NextResponse.json(
				{ error: "Informações nutricionais não encontradas." },
				{ status: 404 },
			);
		}
      ...
      Dados Nutricionais:
      - Calorias: ${nutritionalInfo.calories || "N/A"} kcal
      - Açúcares Adicionados: ${nutritionalInfo.addedSugars || "N/A"} g
      - Gorduras Saturadas: ${nutritionalInfo.saturatedFat || "N/A"} g
      - Sódio: ${nutritionalInfo.sodium || "N/A"} mg
      - Fibras: ${nutritionalInfo.fiber || "N/A"} g
      - Proteínas: ${nutritionalInfo.proteins || "N/A"} g

      Retorne a análise como um único parágrafo de texto amigável e informativo.
    `;
