										...
										>
											<div className="flex items-center gap-3">
												...
												<div>
													...
													<div className="text-sm text-gray-500">
														{product.totalQuantity?.toFixed(1) || 0}{" "}
											...
											<div className="text-right">
												...
												<div className="text-sm text-gray-500">
													{product.totalPurchases || 0} compras
												</div>
											</div>
										</div>
									))}
									...
									(market: any, index: number) => {
										const cheapest =
											stats.marketComparison?.length > 1
												...
												: null;
										const isCheapest =
											cheapest && market.marketId === cheapest.marketId;
										...
										return (
											...
											>
												...
												<div className="text-right">
													<div className="font-medium">
														R$ {(market.averagePrice || 0).toFixed(2)}
													</div>
													<div className="text-sm text-gray-500">
														média por compra
													</div>
								...
								.map((purchase: any) => (
									...
									>
										<div className="flex items-center gap-3">
											...
											<div>
												<div className="font-medium">
													{purchase.market?.name || "Mercado não identificado"}
												</div>
												<div className="text-sm text-gray-500">
													{formatLocalDate(
										...
										<div className="text-right">
											<div className="font-medium">
												R$ {(purchase.totalAmount || 0).toFixed(2)}
											</div>
											<div className="text-sm text-gray-500">
