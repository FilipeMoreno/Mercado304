...
export default function EditarProdutoPage() {
	...
	// Estado para dados nutricionais
	const [nutritionalData, setNutritionalData] = useState<Partial<
		NutritionalInfo
	> | null>(null);
	...
	// Determina se os campos nutricionais devem ser exibidos
