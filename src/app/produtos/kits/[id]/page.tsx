...
import { ArrowLeft, Edit, Package2, AlertCircle, TrendingUp, Apple, DollarSign } from "lucide-react";
...
export default function KitDetailsPage() {
  ...
  const { data: stockData, isLoading: isLoadingStock } = useProductKitStockQuery(
    activeTab === "stock" ? kitId : ""
  );

  const { data: priceData, isLoading: isLoadingPrice } = useProductKitPriceQuery(
    activeTab === "price" ? kitId : ""
  );
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/produtos/kits/${kitId}/editar`)}
          >
          ...
          <TabsContent value="details" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detalhes básicos e produtos inclusos
                </CardDescription>
              </CardHeader>
                ...
                <>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Quantos kits completos podem ser montados
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-secondary/30 rounded-lg">
                          <div>
                            ...
                            <p className="text-3xl font-bold text-primary">
                              {stockData.data.availableQuantity}
                            </p>
                          </div>
                          <Badge
                            variant={
                        ...
                        {stockData.data.limitingProduct && (
                          <div className="p-4 border rounded-lg">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                              Disponível: {stockData.data.limitingProduct.availableQuantity}{" "}
                              | Necessário: {stockData.data.limitingProduct.requiredQuantity}
                            </p>
                          </div>
                        )}
                      </div>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Detalhamento do estoque de cada produto do kit
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                ...
                <Card>
                  <CardContent className="p-6">
                    <p className="text-muted-foreground">
                      Não foi possível carregar informações de estoque
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {isLoadingNutrition ? (
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Valores agregados de todos os produtos do kit
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardContent className="p-6">
                    <p className="text-muted-foreground">
                      Informações nutricionais não disponíveis para este kit
                    </p>
                  </CardContent>
                </Card>
              )}
            ...
            <Suspense fallback={<Skeleton className="h-64 w-full" />}>
              {isLoadingPrice ? (
                ...
                <>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Baseado na soma dos preços individuais dos produtos
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="flex items-center justify-between p-6 bg-primary/10 rounded-lg">
                        <div>
                          <p className="text-sm text-muted-foreground">Preço Total do Kit</p>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Preço individual de cada produto no kit
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                ...
                <Card>
                  <CardContent className="p-6">
                    <p className="text-muted-foreground">
                      Não foi possível calcular o preço do kit
                    </p>
                  </CardContent>
                </Card>
              )}
