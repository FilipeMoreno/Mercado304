...
import { ArrowLeft, ChefHat, Clock, Utensils, Star, ThumbsUp, Save } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><Utensils />Ingredientes</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><ChefHat />Modo de Preparo</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="prose dark:prose-invert">
                {recipe.modo_preparo.split(/(Passo \d+:)/).filter(p => p.trim()).reduce((acc, part, index) => {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-semibold text-yellow-800 flex items-center gap-2"><ThumbsUp size={16}/> Dica do Chef</h4>
                <p className="text-sm text-yellow-700 mt-1">{recipe.dica_chef}</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader><CardTitle>Gostou da Receita?</CardTitle></CardHeader>
            <CardContent className="space-y-4">
