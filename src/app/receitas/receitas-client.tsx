// src/app/receitas/receitas-client.tsx
"use client"
...
import { Plus, ChefHat, Utensils, Trash2, Eye } from "lucide-react"
...
export function ReceitasClient({ initialRecipes, allProducts }: ReceitasClientProps) {
  const router = useRouter()
  const { remove, loading } = useDataMutation()
  const { deleteState, openDeleteConfirm, closeDeleteConfirm } = useDeleteConfirmation<Recipe>()
          ...
          {initialRecipes.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-gray-600">
                Use o "Chefe Virtual" para gerar e salvar suas primeiras receitas.
              </p>
            </div>
          ) : (
