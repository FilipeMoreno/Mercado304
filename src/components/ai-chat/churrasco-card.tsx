		...
		>
			...
			<div className="space-y-2">
				<div className="grid grid-cols-3 gap-2">
					<div>
						<Label htmlFor="adults-chat" className="text-xs">
							Adultos
						</Label>
						<Input
							id="adults-chat"
					...
					<div>
						<Label htmlFor="children-chat" className="text-xs">
							Crianças
						</Label>
						<Input
							id="children-chat"
					...
					<div>
						<Label htmlFor="drinkers-chat" className="text-xs">
							Bebem
						</Label>
						<Input
							id="drinkers-chat"
				...
				<div>
					<Label htmlFor="preferences-chat" className="text-xs">
