      ...
      <div className="w-full h-96 bg-black rounded-lg overflow-hidden relative flex items-center justify-center">
        {isProcessing && capturedImage ? (
          ...
          <>
            ...
            {error && <p className="absolute bottom-4 left-4 right-4 text-center text-white bg-red-800/80 p-2 rounded">{error}</p>}
          </>
        )}
      </div>

      <Button onClick={takePictureAndProcess} className="w-full mt-4" disabled={isProcessing || !!error}>
