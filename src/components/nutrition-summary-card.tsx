...
import { Apple, TrendingUp, AlertTriangle, CheckCircle2, ArrowRight } from "lucide-react"
  ...
  const fetchNutritionSummary = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const avgHealthScore = data.categoryAnalysis.length > 0 
        ...
        const topCategory = data.categoryAnalysis.length > 0
