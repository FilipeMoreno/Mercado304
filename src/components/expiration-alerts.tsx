		...
		return (
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Produtos vencendo ou com estoque baixo
					</CardDescription>
				</CardHeader>
				<CardContent>
		...
		return (
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Nenhum alerta de validade ou estoque
					</CardDescription>
				</CardHeader>
				<CardContent>
		...
		<Card>
				...
				<CardDescription>
					{data.stats.potentialWasteValue > 0 && (
						<span className="text-red-600">
							Risco de desperdício: R${" "}
							{data.stats.potentialWasteValue.toFixed(2)}
						</span>
					)}
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				{allAlerts.slice(0, 8).map((alert) => (
					<div
						key={alert.id}
						className={`border-l-4 ${getAlertColor(alert.alertType)} p-4 rounded-r-lg`}
					>
