            ...
            <div>
              ...
              <div className="space-y-2">
                {discountStats.topDiscountMarkets.slice(0, 3).map((market) => (
                  <div key={market.marketId} className="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-2">
                {discountStats.monthlyDiscounts.slice(-6).map((month) => (
                  <div key={month.month} className="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
