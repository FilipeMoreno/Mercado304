...
import { Brain, TrendingUp, ShoppingCart, Star, Clock, Target, Lightbulb, BarChart3 } from "lucide-react"
				...
				purchaseHistory: [
					{
						date: "2024-01-15",
						products: [
							{ name: "Café", category: "Bebidas", price: 12.90, quantity: 1 },
							{ name: "Açúcar", category: "Condimentos", price: 3.50, quantity: 2 },
							{ name: "Pão de Forma", category: "Padaria", price: 4.20, quantity: 1 }
						],
					...
					},
					{
						date: "2024-01-10",
						products: [
							{ name: "Leite", category: "Laticínios", price: 4.50, quantity: 2 },
							{ name: "Ovos", category: "Proteínas", price: 8.90, quantity: 1 },
							{ name: "Café", category: "Bebidas", price: 12.90, quantity: 1 }
						],
						market: "Supermercado Central",
						total: 30.80
					...
					<div className="space-y-4">
						<div className="text-center">
							<p className="text-sm text-gray-600 mb-2">
								Processando histórico de compras...
							</p>
									...
									<div className="space-y-2">
										...
										<div className="flex items-center justify-between text-sm">
											<span className="font-medium text-green-600">
												R$ {rec.averagePrice.toFixed(2)}
											</span>
											<span className="text-gray-500">
												{rec.frequency}x comprado
											</span>
										</div>
									</div>
									...
									<div key={index} className="flex items-center justify-between">
										<div>
											...
											<p className="text-sm text-gray-600">
												{market.frequency} visitas
											</p>
										</div>
										<div className="text-right">
											<p className="font-medium text-green-600">
												R$ {market.averageSpent.toFixed(2)}
											</p>
									...
									<div key={index} className="space-y-2">
										<div className="flex items-center justify-between">
											...
											<div className="flex items-center gap-2">
												...
												<TrendingUp 
													className={`h-4 w-4 ${
														category.trend === 'increasing' ? 'text-green-500' : 
														category.trend === 'decreasing' ? 'text-red-500' : 'text-gray-500'
													}`} 
												/>
											</div>
										</div>
							...
							<div className="space-y-4">
								<div className="grid grid-cols-2 gap-4">
									...
									<div className="text-center p-3 bg-green-50 rounded-lg">
										<p className="text-lg font-bold text-green-600">
											{patterns.shoppingFrequency.bestDay}
										</p>
								...
								<div className="text-center p-3 bg-purple-50 rounded-lg">
									<p className="text-lg font-bold text-purple-600">
										{patterns.shoppingFrequency.bestTime}
									</p>
