			...
			<AnimatePresence>
				{isOpen && (
					<>
						{/* Overlay */}
						<motion.div
							className={cn("fixed inset-0 bg-black z-40", overlayClassName)}
						...
						>
										...
										{snapPoints.map((point, index) => (
											<button
												...
												className={cn(
													...
													currentSnapPoint === point ? "bg-blue-500" : "bg-gray-300",
												)}
											/>
										))}
									</div>
							...
							{/* Content */}
							<div className="flex-1 overflow-y-auto p-4" onClick={handleItemClick}>
								{children}
							</div>
