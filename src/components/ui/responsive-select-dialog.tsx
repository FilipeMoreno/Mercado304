...
export function ResponsiveSelectDialog({
	...
	return (
		<>
			...
			{/* Dialog */}
			<ResponsiveDialog open={open} onOpenChange={onOpenChange} title={title} maxWidth="md" maxHeight={true}>
						...
						<div className="space-y-1">
							{isLoading && options.length === 0 ? (
								...
								<div className="py-12 text-center">
									...
									{shouldShowCreateNew && (
										<Button type="button" variant="default" size="sm" onClick={handleCreateNew} className="gap-2">
