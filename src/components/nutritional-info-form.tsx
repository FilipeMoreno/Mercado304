...
const optionalFields = [
  ...
  { key: 'thiamine', label: 'Vitamina B1 (Tiamina)', unit: 'mg', category: 'Vitaminas' },
  { key: 'riboflavin', label: 'Vitamina B2 (Riboflavina)', unit: 'mg', category: 'Vitaminas' },
  { key: 'niacin', label: 'Vitamina B3 (Niacina)', unit: 'mg', category: 'Vitaminas' },
  { key: 'vitaminB6', label: 'Vitamina B6', unit: 'mg', category: 'Vitaminas' },
  { key: 'folate', label: 'Folato', unit: 'mcg', category: 'Vitaminas' },
  { key: 'vitaminB12', label: 'Vitamina B12', unit: 'mcg', category: 'Vitaminas' },
  { key: 'biotin', label: 'Biotina', unit: 'mcg', category: 'Vitaminas' },
  { key: 'pantothenicAcid', label: 'Ácido Pantotênico', unit: 'mg', category: 'Vitaminas' },
  // Minerais
  ...
  useEffect(() => {
    if (initialData) {
      ...
      const fieldsWithValues = optionalFields
        .filter(field => initialData[field.key as keyof NutritionalInfo] !== undefined && initialData[field.key as keyof NutritionalInfo] !== null)
        .map(field => field.key)
                ...
                return (
                  <div key={field.key} className="space-y-2 relative">
                    <div className="flex items-center justify-between">
                      <Label htmlFor={field.key}>{field.label} ({field.unit})</Label>
                      <Button
                        type="button"
                        variant="ghost"
                        size="sm"
