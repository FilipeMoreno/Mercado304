...
export function AiAnalysisCard({
  ...
  return (
    <Card className={`relative overflow-hidden border-0 bg-gradient-to-br from-violet-50 via-blue-50 to-cyan-50 dark:from-violet-950/20 dark:via-blue-950/20 dark:to-cyan-950/20 ${className}`}>
