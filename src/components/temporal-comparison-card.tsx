...
import { TrendingUp, TrendingDown, Calendar, ShoppingCart, DollarSign } from "lucide-react"
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {/* Insights */}
        {(temporalData.insights?.spentMore || temporalData.insights?.purchasedMore || temporalData.insights?.higherTicket) && (
